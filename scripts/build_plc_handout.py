...
<header class="cover">
  ...
  <dl class="docmeta">
    <div><dt>Applies to</dt><dd>v0.28.0</dd></div>
    <div><dt>Document</dt><dd>Rev B</dd></div>
...
<footer>
  <p><strong>Extracted from the Pole Position station handbook, part 03, for application v0.28.0.</strong>
