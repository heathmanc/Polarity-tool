...
<header class="cover">
  ...
  <dl class="docmeta">
    <div><dt>Applies to</dt><dd>v0.30.0</dd></div>
    <div><dt>Document</dt><dd>Rev C</dd></div>
...
<footer>
  <p><strong>Extracted from the Pole Position station handbook, part 03, for application v0.30.0.</strong>
